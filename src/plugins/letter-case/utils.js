...
var allCharacters = new Set(Object.values(fonts).join(""));

function alreadyAppended(text, append) {
...
function alreadyFormatted(text, font) {
...
function formatText(text, font, options) {
...
export const uniCodeNormal = (text) => {
	return formatText(text, "normal", {
		clear: true
	});
}

export const uniCodeBoldCase = (text) => {
	return formatText(text, "sansBold");
}

export const uniCodeItalicCase = (text) => {
	return formatText(text, "sansItalic");
}

export const uniCodeMonospaceCase = (text) => {
